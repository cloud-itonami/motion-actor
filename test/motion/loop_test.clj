(ns motion.loop-test
  "Full tick! cycle, fully offline: motion.murakumo/motion.judge/datalad shell
  ...
  (:require [clojure.test :refer [deftest testing is]]
            ...
            [motion.publisher :as publisher]))

(defn- tmp-dir []
  (let [f (java.io.File/createTempFile "motion-loop-test" "")]
    (.delete f) (.mkdirs f) f))
