(ns motion.cacao
  "Agent-side CACAO issuance (JVM) for gftd-motion-actor. 1:1 port of the
  ...
  The private key is persisted to `.motion/identity.edn` (gitignored) —
...
(def default-db-name
  "gftd-motion-actor's own database."
  "motion")
